...
- **Arch**: pacman for nearly everything; oh-my-posh and lazydocker use their official install scripts (AUR-only otherwise); wlogout needs an AUR helper. `SKIP_DESKTOP=1` skips the Hyprland stack.
